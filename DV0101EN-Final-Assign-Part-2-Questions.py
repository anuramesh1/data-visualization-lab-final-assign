...
def update_output_container(dropdown_statistics_value, input_year):
    if dropdown_statistics_value == 'Recession Period Statistics':
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas,
                            x='Year',
                            y='Automobile Sales',
                            title='Average Automobile Sales in the year {}'.format(input_year) ))
